...
void DIO_voidInit(void)
{
	...
	#if ( ( DIO_u8_PIN0_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN0_INIT_VAL != DIO_PIN_INPUT ) )
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN1_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN1_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN2_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN2_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN3_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN3_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN4_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN4_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN5_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN5_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN6_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN6_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN7_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN7_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN8_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN8_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN9_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN9_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN10_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN10_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN11_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN11_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN12_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN12_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN13_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN13_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN014_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN14_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN15_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN15_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN16_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN16_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN17_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN17_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN018_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN18_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN19_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN19_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN20_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN20_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN21_DIR == DIO_INPUT ) && ( DIO_PIN21_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN22_DIR == DIO_INPUT ) && ( DIO_PIN22_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN23_DIR == DIO_INPUT ) && ( DIO_PIN23_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN24_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN24_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN25_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN25_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN26_DIRECTION == DIO_PIN_INIT_INPUT ) && ( DIO_PIN26_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN27_DIRECTION == DIO_PIN_INIT_INPUT ) && ( DIO_PIN27_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN28_DIRECTION == DIO_PIN_INIT_INPUT ) && ( DIO_PIN28_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN29_DIRECTION == DIO_PIN_INIT_INPUT ) && ( DIO_PIN29_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN30_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN30_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
	...
	#endif
	/*																									  */
	#if ( ( DIO_u8_PIN31_DIR == DIO_PIN_INIT_INPUT ) && ( DIO_PIN31_INIT_VAL != DIO_PIN_INPUT ) )
		#warning The Pin You are trying to set is an INPUT Pin, its set now to the default input value
