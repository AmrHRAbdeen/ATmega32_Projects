			...
			for (u8 Local_u8SSDNb = 0 ; Local_u8SSDNb < SSD_NUMBER_OF_SSD ; Local_u8SSDNb ++){
				...
				if ( SSD_Au8ArraySSDType[Local_u8SSDNb] == SSD_COM_CATH ){
					...
					for (u8 Local_u8PinOrder = 0 ; Local_u8PinOrder < SSD_NB_OF_PINs ; Local_u8PinOrder ++){
						...
						if(DIO_u8SetPinDirection( SSD_Au8ArrayToSSDPin[Local_u8SSDNb][Local_u8PinOrder] , SSD_PIN_DIR_OUTPUT) || DIO_u8SetPinValue( SSD_Au8ArrayToSSDPin[Local_u8SSDNb][Local_u8PinOrder] , GET_BIT(SSD_Au8ArraySSDInitVal[Local_u8SSDNb],Local_u8PinOrder)))
						{
							Local_u8ErrorState = ERROR_NOK ;
						}
