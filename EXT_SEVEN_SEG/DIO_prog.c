...
u8 DIO_u8GetPinValue(u8  Copy_u8PinNb, u8 *  Copy_pu8PinValue){
  ...
  u8 Local_u8Error=ERROR_OK;
    ...
    if((Copy_u8PinNb >= DIO_MAXPINNB) || (Copy_pu8PinValue ==NULL)){
      ...
      switch (Local_u8PortId){
        case DIO_PIN_A :
          *Copy_pu8PinValue = GET_BIT(PINA->ByteAccess,Local_u8PinId);
        break;
        case DIO_PIN_B:
          *Copy_pu8PinValue = GET_BIT(PINB->ByteAccess,Local_u8PinId);
        break;
        case DIO_PIN_C:
          *Copy_pu8PinValue = GET_BIT(PINC->ByteAccess,Local_u8PinId);
        break;
        case DIO_PIN_D:
          *Copy_pu8PinValue = GET_BIT(PIND->ByteAccess,Local_u8PinId);
        break;
      }
