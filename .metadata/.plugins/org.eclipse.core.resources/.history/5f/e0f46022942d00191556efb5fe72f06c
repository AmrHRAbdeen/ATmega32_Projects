...
#define SSD_u8_TEN     (u8)10
#define SSD_u8_ELEV    (u8)11
#define SSD_u8_TEWLV   (u8)12
#define SSD_u8_THRET   (u8)13
#define SSD_u8_FOURT   (u8)14
#define SSD_u8_FIFT    (u8)15
#define SSD_u8_SIXT    (u8)16
#define SSD_u8_SEVNT   (u8)17
